...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {		
		...
		//earthquakesURL = "/home/nishimura/Documents/Coursera_Java/Starter_Code/UCSDUnfoldingMaps/data/test1.atom";
		//earthquakesURL = "/home/nishimura/Documents/Coursera_Java/Starter_Code/UCSDUnfoldingMaps/data/test2.atom";

		// WHEN TAKING THIS QUIZ: Uncomment the next line
		earthquakesURL = "/home/nishimura/Documents/Coursera_Java/Starter_Code/UCSDUnfoldingMaps/data/quiz1.atom";
	...
	private void addKey() {	
		...
		fill(0, 0, 0);
		text("Land Quake", 80, 130);
		
		fill(255,255,255);
		rect(50,150,20,20);		
		fill(0, 0, 0);
		text("Ocean Quake", 80, 160);
		...
		fill(255, 255, 0);
		ellipse(60,210,15,15);		
		fill(0, 0, 0);
		text("Shallow", 80, 210);
		
		fill(0, 0, 153);
		ellipse(60,230,15,15);		
		fill(0, 0, 0);
		text("Intermediate", 80, 230);
	...
	private void printQuakes() 
	{
		...
		for (Marker cm : countryMarkers) {
			...
			for (Marker eq : quakeMarkers) {
				...
				Location cLoc = cm.getLocation();
				Location qLoc = em.getLocation();
				if(em.isOnLand()) {
				LandQuakeMarker ecm = (LandQuakeMarker)em;
					
				if (ecm.getCountry() == cName) {
					cQuake++;
			...
			if(cqNumber != 0) {
			System.out.print(cName+":"+cqNumber+"\n");
			}
		}
		System.out.print("OCEAN QUAKES"+":"+oqNumber+"\n");	
	}
